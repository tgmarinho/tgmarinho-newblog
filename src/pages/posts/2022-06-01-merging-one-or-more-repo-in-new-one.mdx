---
title: How to merge two or more repos into a new one without losing the history
description: How to merge two or more repos into a new one without losing the history
publishedAt: '2022-06-01'
category: github
background: '#7AAB13'
---

Go *straight* to **[solution](#technical-way)** 🙏🏻
